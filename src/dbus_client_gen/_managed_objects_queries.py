...
class GMOQuery:
    ...
    def search(self, gmo_result):
        ...
        if self._require_unique:
            ...
            # Can not easily cover this line unless generating tables with
            # valid keys and values, an activity which is not justified to
            # get coverage of this one line at this time. Probably the best
            # way would be via a Hypothesis strategy, as yet unwritten.
            result = (x for x in list_result)  # pragma: no cover
